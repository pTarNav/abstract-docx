...
from abstract_docx.ooxml_docx.structure.properties import ParagraphProperties, NumberingProperties
from abstract_docx.ooxml_docx.structure.styles import ParagraphStyle, OoxmlStyles, OoxmlStyleTypes
from abstract_docx.ooxml_docx.structure.numberings import NumberingStyle, Numbering, OoxmlNumberings
from abstract_docx.ooxml_docx.document.run import Run
