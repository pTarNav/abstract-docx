...
from abstract_docx.ooxml_docx.structure.properties import (
...
class _NumberingStyle(Style):
	...
	Important: Import NumberingStyle from abstract_docx.ooxml_docx.numbering as this definition is incomplete!
	"""
